...
class WordPressSection(BaseModel):
    ...
    level: int | None = Field(None, ge=1, le=6, description="Heading level for headings")
...
class WordPressPost(BaseModel):
    ...
    featured_image: ImageData | None = None
...
class PostContent(BaseModel):
    ...
    instagram: InstagramPost | None = None
    wordpress: WordPressPost | None = None
    shared_image: ImageData | None = None
